...
{
   UIColor *regularColor= [UIColor colorWithRed:(52/255.0f) green:(78/255.0f) blue:(113/255.0f) alpha:1.0];
    return regularColor;
}
+(UIColor *)colorSecondary

{
    UIColor *regularColor= [UIColor colorWithRed:(92/255.0f) green:(102/255.0f) blue:(119/255.0f) alpha:1.0];
    return regularColor;
}
#pragma mark - Fonts
