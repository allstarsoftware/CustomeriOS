...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:NSLocalizedStringFromTable(@"Logout",[prefl objectForKey:@"TranslationDocumentName"], nil) message:NSLocalizedStringFromTable(@"Logout Msg",[prefl objectForKey:@"TranslationDocumentName"], nil) delegate:self cancelButtonTitle:NSLocalizedStringFromTable(@"No", [prefl objectForKey:@"TranslationDocumentName"], nil) otherButtonTitles:NSLocalizedStringFromTable(@"Yes", [prefl objectForKey:@"TranslationDocumentName"], nil), nil];
        alert.tag=100;
        [alert show];
